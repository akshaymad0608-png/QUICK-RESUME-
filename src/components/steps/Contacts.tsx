  ...
  return (
    <div className="space-y-6">
      <div className="mb-6">
        ...
        <p className="text-gray-500">Get started with the basic information.</p>
      </div>

      <div className="mb-6 flex items-center justify-center">
        <div className="relative group w-32 h-32 rounded-full border-2 border-dashed border-gray-300 overflow-hidden flex items-center justify-center hover:border-blue-500 transition-colors">
          {info.photoUrl ? (
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="md:col-span-2">
          <label className="block text-sm font-semibold text-gray-700 mb-1">Desired Job Title</label>
          <input 
        ...
        <div>
          ...
          <div className="flex gap-2">
            <input 
              ...
              className="w-20 bg-gray-50 border border-gray-200 rounded-lg px-3 py-3 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-colors text-center"
              placeholder="+1"
            />
            <input 
              type="tel" name="phone" value={info.phone} onChange={handleChange} 
              className="flex-1 bg-gray-50 border border-gray-200 rounded-lg px-4 py-3 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-colors"
            />
          </div>
        </div>
      ...
      <button 
        ...
        className="flex items-center gap-2 text-blue-600 font-semibold hover:text-blue-700 transition-colors mt-4"
      >
      ...
      {showAdditional && (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4 animate-in slide-in-from-top-2 opacity-0 fade-in duration-200 fill-mode-forwards">
          ...
          <div>
            <label className="block text-sm font-semibold text-gray-700 mb-1">Website / Portfolio</label>
            <input 
