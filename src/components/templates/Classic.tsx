...
const Classic: FC<TemplateProps> = ({ data }) => {
  ...
  return (
    <div className="w-full flex-1 flex" style={{ fontFamily: design.fontFamily, color: '#333', fontSize: design.fontSize || '14px' }}>
      
      {/* Sidebar */}
      <div className="w-1/3 bg-gray-50 flex flex-col p-8 border-r border-gray-200" style={{ backgroundColor: '#f8fafc' }}>
         <div className="text-center flex flex-col items-center" style={{ marginBottom: sectionGap }}>
            ...
            <h1 className="text-3xl font-bold uppercase tracking-wider mb-2 text-gray-900 text-left w-full" style={{ color: c }}>
              {personalInfo.firstName} <br/> {personalInfo.lastName}
            </h1>
            <div className="text-lg font-medium text-gray-600 tracking-wide uppercase text-left w-full">
              {personalInfo.jobTitle}
            </div>
         </div>

         {/* Contacts */}
         <div className="space-y-3 test-sm text-gray-600" style={{ marginBottom: sectionGap }}>
         ...
         {skills.length > 0 && (
           <div style={{ marginBottom: sectionGap }}>
             <h2 className="text-sm font-bold uppercase tracking-widest border-b-2 pb-2 mb-4" style={{ borderColor: c, color: c }}>Skills</h2>
      ...
      <div className="w-2/3 p-8 bg-white">
          ...
          {summary && (
            <div style={{ marginBottom: sectionGap }}>
              <h2 className="text-sm font-bold uppercase tracking-widest border-b-2 pb-2 mb-4" style={{ borderColor: c, color: c }}>Profile</h2>
          ...
          {experience.length > 0 && (
            <div style={{ marginBottom: sectionGap }}>
              <h2 className="text-sm font-bold uppercase tracking-widest border-b-2 pb-2 mb-4" style={{ borderColor: c, color: c }}>Experience</h2>
          ...
          {education.length > 0 && (
            <div style={{ marginBottom: sectionGap }}>
              <h2 className="text-sm font-bold uppercase tracking-widest border-b-2 pb-2 mb-4" style={{ borderColor: c, color: c }}>Education</h2>
