...
const Modern: FC<TemplateProps> = ({ data }) => {
  ...
  return (
    <div className="w-full flex-1 bg-white flex flex-col" style={{ fontFamily: design.fontFamily, fontSize: design.fontSize || '14px' }}>
      ...
      <div className="flex flex-1">
        ...
        <div className="w-[35%] bg-gray-50 p-8 border-r border-gray-200">
          ...
          <div style={{ marginBottom: sectionGap }}>
            <h2 className="text-sm font-bold uppercase tracking-widest mb-4 border-b pb-2" style={{ color: c, borderColor: c }}>Contact</h2>
          ...
          {skills.length > 0 && (
            <div style={{ marginBottom: sectionGap }}>
              <h2 className="text-sm font-bold uppercase tracking-widest mb-4 border-b pb-2" style={{ color: c, borderColor: c }}>Skills</h2>
        ...
        <div className="w-[65%] p-8 pt-10">
          ...
          {experience.length > 0 && (
            <div style={{ marginBottom: sectionGap }}>
              <h2 className="text-sm font-bold uppercase tracking-widest mb-4 border-b pb-2" style={{ color: c, borderColor: c }}>Experience</h2>
          ...
          {education.length > 0 && (
            <div style={{ marginBottom: sectionGap }}>
               <h2 className="text-sm font-bold uppercase tracking-widest mb-4 border-b pb-2" style={{ color: c, borderColor: c }}>Education</h2>
               <div className="space-y-4">
                {education.map(edu => (
                  <div key={edu.id}>
                    <div className="flex justify-between items-baseline mb-1">
                      <div className="font-bold text-gray-900 text-[15px]">{edu.degree}</div>
                      <div className="text-[12px] font-bold" style={{ color: c }}>
